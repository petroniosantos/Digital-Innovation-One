...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Petrônio Santos";
    private static final String CONTACT_GITHUB = "https://gtihub.com/petroniosantos";
    private static final String CONTACT_EMAIL = "petroniosoliveira@gmail.com";
